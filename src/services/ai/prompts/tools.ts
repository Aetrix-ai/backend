...
// // Type definition for LangChain-compatible tool schemas
...
// // Function to convert definitions to Tools with logging
// export function getTools(): any {
//   return LangChainTools.map((toolDef) => {
//     return {
//       name: toolDef.name,
//       description: toolDef.description,
//       schema: toolDef.schema,
//       func: async (input: any) => {
//         console.log(`Tool called: ${toolDef.name}`);
//         return `Tool ${toolDef.name} was called`;
//       },
//     };
//   });
// }

// export const LangChainTools: LangChainToolDefinition[] = [
//   {
//     name: "lov-add-dependency",
//     description:
//       "Use this tool to add a dependency to the project. The dependency should be a valid npm package name. Usage:\n\n package-name@version\n",
//     schema: z.object({
//       package: z.string().describe("npm package name with version, e.g., 'lodash@latest'"),
//     }),
//   },
//   {
...
//     schema: z.object({
//       query: z.string().describe("Regex pattern to search for, e.g., 'useEffect\\\\('"),
//       include_pattern: z.string().describe("Files to include using glob syntax, e.g., 'src/'"),
//       exclude_pattern: z.string().optional().describe("Files to exclude using glob syntax, e.g., 'src/components/ui/'"),
//       case_sensitive: z.boolean().optional().describe("Whether to match case (default: false)"),
//     }),
//   },
//   {
//     name: "lov-write",
...
//     schema: z.object({
//       file_path: z.string().describe("Path to the file to write, e.g., 'src/main.ts'"),
//       content: z.string().describe("Content to write to the file, e.g., \"console.log('Hello, World!')\""),
//     }),
//   },
//   {
...
//     schema: z.object({
//       file_path: z.string().describe("Path to the file to modify, e.g., 'src/components/TaskList.tsx'"),
//       search: z
//         .string()
//         .describe(
//           "Content to search for in the file (without line numbers). This should match the existing code that will be replaced."
//         ),
//       first_replaced_line: z.number().describe("First line number to replace (1-indexed)"),
//       last_replaced_line: z.number().describe("Last line number to replace (1-indexed)"),
//       replace: z.string().describe("New content to replace the search content with (without line numbers)"),
//     }),
//   },
//   {
//     name: "lov-download-to-repo",
//     description:
//       "Download a file from a URL and save it to the repository.\n\nThis tool is useful for:\n- Downloading images, assets, or other files from URLs. Download images in the src/assets folder and import them as ES6 modules.\n- Saving external resources directly to the project\n- Migrating files from external sources to the repository\n\nThe file will be downloaded and saved at the specified path in the repository, ready to be used in the project.",
//     schema: z.object({
//       source_url: z.string().describe("The URL of the file to download, e.g., 'https://example.com/image.png'"),
//       target_path: z
//         .string()
//         .describe(
//           "The path where the file should be saved in the repository (use the public folder unless specified otherwise), e.g., 'public/images/logo.png'"
//         ),
//     }),
//   },
//   {
...
//     description:
//       "Fetches a website and temporarily saves its content (markdown, HTML, screenshot) to files in `tmp://fetched-websites/`. Returns the paths to the created files and a preview of the content.",
//     schema: z.object({
//       url: z.string().describe("URL of the website to fetch, e.g., 'https://example.com'"),
//       formats: z
//         .string()
//         .optional()
//         .describe(
//           "Comma-separated list of formats to return. Supported formats: 'markdown', 'html', 'screenshot'. Defaults to 'markdown', e.g., 'markdown,screenshot'"
//         ),
//     }),
//   },
//   {
...
//     schema: z.object({
//       search: z.string().describe("Search query to filter logs, e.g., 'error'"),
//     }),
//   },
//   {
...
//     schema: z.object({
//       search: z.string().describe("Search query to filter requests, e.g., 'error'"),
//     }),
//   },
//   {
...
//     schema: z.object({
//       package: z.string().describe("Package name to remove, e.g., 'lodash'"),
//     }),
//   },
//   {
//     name: "lov-rename",
...
//     schema: z.object({
//       original_file_path: z.string().describe("Original file path, e.g., 'src/main.ts'"),
//       new_file_path: z.string().describe("New file path, e.g., 'src/main_new2.ts'"),
//     }),
//   },
//   {
//     name: "lov-delete",
...
//         .optional()
//         .describe(
//           "The model to use for generation. Options: flux.schnell (default), flux.dev. flux.dev generates higher quality images but is slower. Always use flux.schnell unless you're generating a large image like a hero image or fullscreen banner, of if the user asks for high quality."
//         ),
//     }),
//   },
//   {
...
//     description:
//       "Read the analytics for the production build of the project between two dates, with a given granularity. The granularity can be 'hourly' or 'daily'. The start and end dates must be in the format YYYY-MM-DD.\nThe start and end dates should be in RFC3339 format or date only format (YYYY-MM-DD).\n\nWhen to use this tool:\n- When the user is asking for usage of their app\n- When users want to improve their productions apps",
//     schema: z.object({
//       startdate: z.object({}).describe("Start date in RFC3339 format or YYYY-MM-DD"),
//       enddate: z.object({}).describe("End date in RFC3339 format or YYYY-MM-DD"),
//       granularity: z.string().describe("Granularity of analytics data: 'hourly' or 'daily'"),
//     }),
//   },
// ];
// export const tools = [
...
//         target_path: {
//           description:
//             "The path where the file should be saved in the repository (use the public folder unless specified otherwise)",
...
//         formats: {
//           description:
//             "Comma-separated list of formats to return. Supported formats: 'markdown', 'html', 'screenshot'. Defaults to 'markdown'.",
